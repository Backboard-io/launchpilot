...
class ResearchRun(Base, ProjectIdMixin, UUIDPrimaryKeyMixin):
...
class Competitor(Base, ProjectIdMixin, UUIDPrimaryKeyMixin):
...
class PainPointCluster(Base, ProjectIdMixin, UUIDPrimaryKeyMixin):
...
class OpportunityWedge(Base, ProjectIdMixin, UUIDPrimaryKeyMixin):
