...
import { getAuthConfigError, isAuthEnabled, signIn } from "@/lib/auth";
    ...
    <main className="relative flex min-h-screen items-center justify-center p-6">
      ...
      <div className="relative w-full max-w-md animate-slide-up">
        ...
        <div className="rounded-xl border border-edge-subtle bg-surface-muted p-8 shadow-card">
          ...
          {!authConfigured && authConfigError && (
          ...
          <div className="space-y-3">
            <form action={signInWithGitHub}>
              <button
                type="submit"
                className="flex w-full items-center justify-center gap-3 rounded-lg border border-edge-subtle bg-surface-elevated px-4 py-2.5 text-sm font-medium text-fg-secondary transition-colors hover:border-edge-muted hover:text-fg-primary"
              >
            ...
            <Link
              href="/app"
              className="flex items-center justify-center gap-3 rounded-lg bg-surface-elevated px-4 py-2.5 text-sm font-medium text-fg-muted transition-colors hover:bg-surface-muted"
            >
