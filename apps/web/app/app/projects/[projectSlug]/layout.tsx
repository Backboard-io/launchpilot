...
import { ChatCollapseProvider } from "@/components/project/chat-collapse-context";
import { ProjectFlowNav } from "@/components/project/project-flow-nav";
import { ProjectLayoutGrid } from "@/components/project/project-layout-grid";
  ...
  return (
    <ChatCollapseProvider>
      <div className="space-y-6">
        ...
        <ProjectLayoutGrid>{children}</ProjectLayoutGrid>
      </div>
    </ChatCollapseProvider>
  );
}
