...
variable "app_base_url" {
  type        = string
  description = "Public base URL of the application (e.g. https://app.growthlaunchpad.app). Used for APP_BASE_URL, NEXT_PUBLIC_APP_URL, WEB_APP_URL, AUTH_URL."
}
...
variable "next_public_api_base_url" {
  type        = string
  description = "Public API base URL for the browser client (NEXT_PUBLIC_API_BASE_URL), e.g. https://app.growthlaunchpad.app/v1."
}
...
variable "app_jwt_namespace" {
  ...
  default     = "https://growthlaunchpad.app"
}
...
variable "resend_from_email" {
  ...
  default     = "noreply@growthlaunchpad.app"
}
