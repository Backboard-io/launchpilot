...
output "ecr_push_commands" {
  ...
  value = [
    ...
    "docker buildx build --platform linux/amd64 -f docker/dockerfile.dev -t launchpilot .",
    "docker tag launchpilot:latest ${module.ecr.repository_url}:${var.environment}-${var.ecr_image_tag}",
